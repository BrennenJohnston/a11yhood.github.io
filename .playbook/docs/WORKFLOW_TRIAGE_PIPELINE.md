...
## Audit-specific conversion checklist

When converting formal accessibility audit findings into GitHub issues, use the
step-by-step checklist in
[`checklists/audit-to-issues.md`](../checklists/audit-to-issues.md). It covers
severity mapping, scope guards, acceptance criteria, and labeling for each
finding.
