...
The a11yhood project confirmed this pattern independently: a research plan
delegated primary-source reading of 27 documents (meeting transcripts, audit
reports, planning notes) to lower-tier subagents, producing summaries that
became the foundation for all downstream synthesis and development planning.
Every artifact built on those summaries inherited their errors. The entire
research output had to be re-processed with the primary model reading every
