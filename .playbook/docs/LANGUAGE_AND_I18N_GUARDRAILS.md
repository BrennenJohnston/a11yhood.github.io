...
## Real-world example: a11yhood audit finding

A significant portion of scraped products in the a11yhood project are in
non-English languages with no `lang` attributes. Screen readers read foreign
text with English pronunciation, making it unintelligible (WCAG 3.1.2,
Severity: Severe). This is not a theoretical risk -- it was identified as a
severe finding in the project's formal accessibility audit.
