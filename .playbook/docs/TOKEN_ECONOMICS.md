...
token costs invisibly with each interaction. A key question from the project's
planning notes: "Do those baseline preferences bloat your tokens every time you
send them?" The answer is yes -- and managing that bloat is a core cost discipline.
