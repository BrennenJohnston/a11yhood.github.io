...
Based on Open Source Guides Section 6 ("Building Welcoming Communities") and
the project's community-building planning notes:

### Community-building principles

1. **Create initial core of visible value before opening doors.** A handful of
   well-crafted examples demonstrate what quality looks like.
2. **Accommodate diverse motivations.** Contributors arrive for compliance,
   self-interest, public service, or community do-gooding. Design for all four.
3. **Keep barriers to entry low.** Better to get many medium-quality contributions
   than scare people off with high bars.
4. **Design for legitimate peripheral participation.** Scaffold new contributors
   so they can engage meaningfully without causing damage.
5. **Navigate the key tension:** low barriers vs. maintaining accessibility quality.
...
### Alt-text contribution events

A concrete non-code contribution pathway: PRs with placeholder alt text are
submitted by maintainers, then community members fill in accurate descriptions.
Contributors appear in project history for meaningful, impactful work that
requires human judgment -- not AI generation.

### Scaffolded complexity pathway

New contributors follow an escalating path of responsibility:

1. **Docs and link checks** -- low risk, immediate value
2. **CSS and styling** -- visual impact, contained scope
3. **Component logic** -- requires understanding patterns
4. **Data and API work** -- highest trust, broadest impact

New contributors should demonstrate human competence at each level before
submitting AI-generated (AIL-2) work.
