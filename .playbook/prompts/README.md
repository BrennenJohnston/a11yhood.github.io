...
| 11 | `11-accessibility-remediation.md` | Accessibility remediation (+ audit findings) | Persona (WCAG specialist) |
| 12 | `12-new-feature-design.md` | New feature design (OSS-first + gold standard) | Chain-of-thought (search then build) |
| 13 | `13-responsive-ui-change.md` | Responsive UI change | Persona (responsive engineer) |
| 14 | `14-3d-print-at-device.md` | 3D-printed AT device design (+ AI limitations) | Persona (AT engineer) |
| 15 | `15-open-source-contribution.md` | Open source contribution (+ scaffolded pathway) | Persona (community contributor) |
...
- From the project's planning notes: "Process, not rules." These prompts are
  starting points for a conversation with the AI, not fixed templates. Adapt
  them to your project's current phase (BUILD / REFACTOR / STABILIZE).
- All 16 prompts now include scope containment, safeguards-over-features, and
  legacy code constraints as cross-cutting defaults. No new prompts are needed --
  the existing 16 cover all identified scenarios.
