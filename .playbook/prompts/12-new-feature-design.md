...
## MANDATORY SECOND STEP: GOLD STANDARD CHECK
Before writing ANY implementation code, verify that a human-crafted gold
standard exists for this component pattern. If none exists, your first task is
to propose one -- not to build the feature. AI replicates patterns designed by
humans; it does not architect.
